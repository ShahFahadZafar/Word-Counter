...
console.log(
  chalk.bold.magentaBright(
    "This project will count the number of words and letters in your sentence."
  )
);
console.log(
  chalk.bold.magentaBright(
...
while (true) {
  ...
  console.log(
    chalk.bold.greenBright(
      `Your sentence has : ${chalk.bold.yellowBright(
        words.length
      )} words and : ${chalk.bold.yellowBright(letters.length)} letters. `
    )
  );
  console.log(
    chalk.bold.greenBright(
